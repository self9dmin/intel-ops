...
export const MISSIONS: Mission[] = [
  ...
  },
  {
    ...
    role: "All Roles",
    difficulty: "rookie",
    description: "You just logged in. The Playground is live. Before anything breaks, learn what Dynatrace is showing you and where everything lives.",
    briefing: "Every operator needs to know the terrain before the first alert fires. The Playground home screen is your starting point — it shows you what Dynatrace can do, where to get help, and how to navigate the platform. Spend 5 minutes here before you need it under pressure. Use the Dynatrace Playground at https://playground.apps.dynatrace.com",
    timerSeconds: 300,
    status: "available",
    prerequisites: [],
    ...
    checkpoints: [
      {
        ...
        instruction: "Open the Dynatrace Playground at https://playground.apps.dynatrace.com. What is the title of the first featured content block on the home screen?",
        hint: "Look at the large banner card at the top of the home screen — it shows a featured Dynatrace topic with a title and description.",
        type: "multiple-choice",
        choices: [
          "Perform 2026: Replays & highlights",
          "Get started with Dynatrace",
          "Explore common use cases",
          "What is Dynatrace?",
        ],
        correctChoice: "Perform 2026: Replays & highlights",
        points: 75,
      },
      {
        id: "cp2",
        title: "Getting Started Resources",
        instruction: "In the 'Get started with Dynatrace' section, how many quick-start links are listed?",
        hint: "Look for the section with rocket icon links — count every link in that section.",
        type: "multiple-choice",
        choices: ["2", "3", "4", "5"],
        correctChoice: "4",
        points: 75,
      ...
      {
        id: "cp3",
        title: "Find the Assist Shortcut",
        instruction: "Look at the left sidebar (the Dock). What is the keyboard shortcut to open Dynatrace Assist?",
        hint: "The shortcut is shown next to the Assist label in the Dock — look for Ctrl + a key.",
        type: "multiple-choice",
        choices: ["Ctrl + A", "Ctrl + I", "Ctrl + K", "Ctrl + Space"],
      ...
      },
      {
        ...
        instruction: "Look at the left sidebar. The Problems item shows a red badge with a number. What does this number represent?",
        hint: "The red badge on Problems in the sidebar is a live counter — it tells you something specific about the current state of your environment.",
        type: "multiple-choice",
        choices: [
          "The number of alerts that fired today",
          "The number of currently active problems detected by Davis AI",
          "The number of unread notifications",
          "The number of monitored hosts",
        ],
        correctChoice: "The number of currently active problems detected by Davis AI",
        points: 100,
      },
    ],
  },
